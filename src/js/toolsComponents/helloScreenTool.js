...
function HelloScreenTool(props) {
  const [types, setTypes] = useState([
    {
      visitors: props.dataContents[`visitors`],
      visitorsText: props.dataContents[`visitors_text`],
    },
    {
      sellers: props.dataContents[`sellers`],
      sellersText: props.dataContents[`sellers_text`],
    },
    {
      versions: props.dataContents[`versions`],
      versionsText: props.dataContents[`versions_text`],
    },
    {
      years: props.dataContents[`years`],
      yearsText: props.dataContents[`years_text`],
    },
  ]);
  const [slogan, setSlogan] = useState(props.dataContents.slogan);
  const [heading, setHeading] = useState(props.dataContents.heading);
